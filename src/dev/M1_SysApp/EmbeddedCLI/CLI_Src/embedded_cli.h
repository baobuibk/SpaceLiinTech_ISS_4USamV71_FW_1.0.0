#ifndef M2_SYSTEM_CLI_TERMINAL_CLI_SRC_EMBEDDED_CLI_H_
#define M2_SYSTEM_CLI_TERMINAL_CLI_SRC_EMBEDDED_CLI_H_
...
struct EmbeddedCliConfig {
     ...
     */
    _Bool enableAutoComplete;

    /*
     * Modify for static binding:
     */
    const CliCommandBinding *staticBindings;   // Pointer Array CMD
    uint16_t staticBindingCount;                // Number of static binding
...
void embeddedCliSetAutoComplete(EmbeddedCli *cli, bool enable);

bool embeddedCliGetAutoComplete(EmbeddedCli *cli);
...
#endif /* M2_SYSTEM_CLI_TERMINAL_CLI_SRC_EMBEDDED_CLI_H_ */
