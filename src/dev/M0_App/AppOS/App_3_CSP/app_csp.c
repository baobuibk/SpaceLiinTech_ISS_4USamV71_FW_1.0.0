...
#include "M1_SysApp/rparam/sh_handler.h"
...
void App_CSPTask(void *param)
{
    ...
    /* Step 2: Wire shell-tunnel callback and start worker */
    sh_handler_set_table(&g_tables[1]);
    g_tables[1].callback = sh_table1_callback;
    sh_handler_start();
