 ...
 * Author: HTSANG
 *
 * Created on June 14, 2026, 3:16 PM
 */
...
#define MAX22200_R1B                BIT(0)

#define MAX22200_STATUS_REG         ((0x00 << 1) | 0)
#define MAX22200_CFG_CH(x)          (((0x01 + (0x01 * (x))) << 1) | 0)
#define MAX22200_FAULT_REG          ((0x09 << 1) | 0)
#define MAX22200_CFG_DPM_REG		((0x0A << 1) | 0)

/* Write/Read Masks */
#define MAX22200_RW_MASK            BIT(7)
#define MAX22200_ADDR_MASK          GENMASK(6, 0)

/* Status Register Masks */
#define MAX22200_ONCH_MASK(x)		BIT((x) + 24)
#define MAX22200_STATUS_ONCH_MASK	GENMASK(31, 24)
#define MAX22200_STATUS_FREQ_MASK	BIT(16)
#define MAX22200_STATUS_FAULT_MASK(x)	BIT(x)
#define MAX22200_STATUS_MODE_MASK	GENMASK(15, 8)
#define MAX22200_CH_MODE_MASK(x)	GENMASK(9 + (2 * (x)), 8 + (2 * (x)))
#define MAX22200_STATUS_FLAG_MASK	GENMASK(7, 0)
#define MAX22200_ACTIVE_MASK		BIT(0)

/* CFG CH Register Masks */
#define MAX22200_HFS_MASK           BIT(31)
#define MAX22200_HOLD_MASK          GENMASK(30, 24)
#define MAX22200_TRGNSP_IO_MASK		BIT(23)
#define MAX22200_HIT_MASK           GENMASK(22, 16)
#define MAX22200_HIT_T_MASK         GENMASK(15, 8)
#define MAX22200_VDRNCDR_MASK		BIT(7)
#define MAX22200_HSNLS_MASK         BIT(6)
#define MAX22200_FREQ_CFG_MASK		GENMASK(5, 4)
#define MAX22200_CH_ENABLE_MASK(x)	BIT(x)

/* CFG DPM Register Masks */
#define MAX22200_DPM_ISTART_MASK	GENMASK(14, 8)
#define MAX22200_DPM_TDEB_MASK		GENMASK(7, 4)
#define MAX22200_DPM_IPTH_MASK		GENMASK(3, 0)
...
int max22200_init(struct max22200_desc **, const struct max22200_init_param *);
